...
export function BankAdminSidebar({
  collapsed = false,
  onToggle,
  darkMode = false,
}: BankAdminSidebarProps) {
  const dark = darkMode;
      ...
      <div style={{
        ...
        {!collapsed && (
          <div style={{ overflow: 'hidden' }}>
            ...
            <div style={{ fontFamily: F.inter, fontSize: '11px', color: groupLabelColor, whiteSpace: 'nowrap', marginTop: '1px' }}>
              Bank Admin
            </div>
          </div>
        )}
...
/* ─── Standalone interactive demo (for showcase page) ───────────────────── */
...
export function BankAdminSidebarDemo() {
  ...
  return (
    <div style={{
      ...
      {/* ── Expanded — Dark ── */}
      <div>
        <StateLabel text="Expanded · Dark Theme" dark={true} />
      ...
      {/* ── Collapsed — Dark ── */}
      <div>
        <StateLabel text="Collapsed · Dark Theme" dark={true} />
